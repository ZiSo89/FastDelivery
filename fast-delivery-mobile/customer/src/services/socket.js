...
class SocketService {
  ...
  connect() {
    ...
    this.socket.on('connect', () => {
      ...
      if (this.currentRoom) {
        console.log('🔌 Re-joining room:', this.currentRoom);
  ...
  joinRoom(data) {
    ...
    if (this.socket && this.socket.connected) {
      ...
      console.log('🔌 Room stored, will join on connect:', data);
    }
  }
  ...
  attachPendingListeners() {
    ...
    console.log('🔌 Attaching', this.pendingListeners.size, 'pending listener types');
